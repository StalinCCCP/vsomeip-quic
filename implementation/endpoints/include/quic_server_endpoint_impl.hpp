...
#ifndef VSOMEIP_V3_QUIC_SERVER_ENDPOINT_IMPL_HPP_
#define VSOMEIP_V3_QUIC_SERVER_ENDPOINT_IMPL_HPP_
...
typedef server_endpoint_impl<
            quic_adaptor::quic_server_adaptor
        > quic_server_endpoint_base_impl;

class /*__attribute__((visibility("default")))*/ quic_server_endpoint_impl: public quic_server_endpoint_base_impl {

public:
    quic_server_endpoint_impl(const std::shared_ptr<endpoint_host>& _endpoint_host,
                             const std::shared_ptr<routing_host>& _routing_host,
                             const endpoint_type& _local,
                             boost::asio::io_context &_io,
                             const std::shared_ptr<configuration>& _configuration);
    virtual ~quic_server_endpoint_impl();
...
private:
    ...
    public:
        ...
        static ptr create(const std::weak_ptr<quic_server_endpoint_impl>& _server,
    ...
    private:
        ...
        quic_server_endpoint_impl::socket_type socket_;
        std::weak_ptr<quic_server_endpoint_impl> server_;
